        ...
        <div class="box-body">
          <div class="table-responsive">              	
              <table class="table no-margin">
				...
				<c:forEach var="u" items="${medicos}">
					<tr>
						<td>${u.nome == null ? '' : u.nome}</td>
						<td>${u.cpf == null ? '' : u.cpf}</td>
						<td>${u.crm == null ? '' : u.crm}</td>
						<td>${u.especialidade == null ? '' : u.especialidade}</td>
						<td>
							<a href="${pageContext.request.contextPath}/admin/medicos?id=${u.id}&action=editar" class="btn btn-sm btn-primary">Editar</a>&nbsp;&nbsp;&nbsp;                        		
