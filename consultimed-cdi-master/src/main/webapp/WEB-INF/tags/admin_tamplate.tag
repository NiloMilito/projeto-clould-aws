  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="${pageContext.request.contextPath}/admin/contatos?action=list"><i class="fa fa-address-book-o text-aqua"></i> <span>Contatos</span></a></li>
        <li><a href="${pageContext.request.contextPath}/admin/usuarios?action=list"><i class="fa fa-users text-aqua"></i> <span>Usuários</span></a></li>
	    <li><a href="${pageContext.request.contextPath}/admin/medicos?action=list"><i class="fa fa-user-md text-aqua"></i> <span>Médicos</span></a></li>
        <li><a href="${pageContext.request.contextPath}/admin/exames?action=list"><i class="fa fa-file-text-o text-aqua"></i> <span>Exames</span></a></li>
	    <li><a href="${pageContext.request.contextPath}/admin/consultas?action=list"><i class="fa fa-stethoscope text-aqua"></i> <span>Consultas</span></a></li>
        <li><a href="${pageContext.request.contextPath}/admin/pacientes?action=list"><i class="fa fa-male text-aqua"></i> <span>Pacientes</span></a></li>
